(function () {
  const translations = {
    ja: {
      ...
      download_desc:
        'v2.7.12 — 信号記録・再生、テスト信号ツール、ガーディアン、クラスター冗長を搭載。',
      dl_win: 'Windows',
      dl_win_version: 'v2.7.12 · Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.7.12 · Portable (.exe)',
      dl_mac: 'macOS (Apple Silicon)',
      dl_mac_version: 'v2.7.12 · DMG (.dmg)',
    ...
    en: {
      ...
      download_desc:
        'v2.7.12 \u2014 Signal recording/playback, test signal tool, Guardian, and cluster redundancy.',
      dl_win: 'Windows',
      dl_win_version: 'v2.7.12 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.7.12 \u00b7 Portable (.exe)',
    ...
    de: {
      ...
      download_title: 'Download',
      download_desc:
        'v2.7.12 \u2014 Signalaufnahme/-wiedergabe, Testsignal-Tool, Guardian und Cluster-Redundanz.',
      dl_win: 'Windows',
      dl_win_version: 'v2.7.12 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.7.12 \u00b7 Portable (.exe)',
    ...
    fr: {
      ...
      download_desc:
        'v2.7.12 \u2014 Enregistrement/lecture de signal, outil de test, Guardian et redondance cluster.',
      dl_win: 'Windows',
      dl_win_version: 'v2.7.12 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.7.12 \u00b7 Portable (.exe)',
    ...
    es: {
      ...
      download_desc:
        'v2.7.12 \u2014 Grabaci\u00f3n/reproducci\u00f3n de se\u00f1al, herramienta de prueba, Guardian y redundancia cluster.',
      dl_win: 'Windows',
      dl_win_version: 'v2.7.12 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.7.12 \u00b7 Portable (.exe)',
    ...
    it: {
      ...
      download_desc:
        'v2.7.12 \u2014 Registrazione/riproduzione segnale, strumento di test, Guardian e ridondanza cluster.',
      dl_win: 'Windows',
      dl_win_version: 'v2.7.12 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.7.12 \u00b7 Portable (.exe)',
    ...
    nl: {
      ...
      download_desc:
        'v2.7.12 \u2014 Signaalopname/-afspelen, testsignaal-tool, Guardian en cluster-redundantie.',
      dl_win: 'Windows',
      dl_win_version: 'v2.7.12 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.7.12 \u00b7 Portable (.exe)',
    ...
    pt: {
      ...
      download_title: 'Download',
      download_desc:
        'v2.7.12 \u2014 Grava\u00e7\u00e3o/reprodu\u00e7\u00e3o de sinal, ferramenta de teste, Guardian e redund\u00e2ncia de cluster.',
      dl_win: 'Windows',
      dl_win_version: 'v2.7.12 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.7.12 \u00b7 Portable (.exe)',
    ...
    zh: {
      ...
      download_title: '\u4e0b\u8f7d',
      download_desc:
        'v2.7.12 \u2014 \u4fe1\u53f7\u5f55\u5236/\u56de\u653e\u3001\u6d4b\u8bd5\u4fe1\u53f7\u5de5\u5177\u3001Guardian \u548c\u96c6\u7fa4\u5197\u4f59\u3002',
      dl_win: 'Windows',
      dl_win_version: 'v2.7.12 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.7.12 \u00b7 Portable (.exe)',

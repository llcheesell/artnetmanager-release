(function () {
  const translations = {
    ja: {
      ...
      hero_download_btn: 'Download v2.8.9',
      ...
      dl_win: 'Windows',
      dl_win_version: 'v2.8.9 · Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.8.9 · Portable (.exe)',
      dl_mac: 'macOS (Universal)',
      dl_mac_version: 'v2.8.9 · DMG (.dmg)',
      dl_btn: 'Download',
      disclaimer_p1:
    ...
    en: {
      ...
      download_desc:
        'v2.8.9 — macOS builds are now signed with a Developer ID certificate and notarized by Apple. No more Gatekeeper warning on first launch.',
      dl_win: 'Windows',
      dl_win_version: 'v2.8.9 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.8.9 \u00b7 Portable (.exe)',
    ...
    de: {
      ...
      download_title: 'Download',
      download_desc:
        'v2.8.9 — macOS-Builds werden jetzt mit einem Developer ID-Zertifikat signiert und von Apple beglaubigt. Keine Gatekeeper-Warnung beim ersten Start.',
      dl_win: 'Windows',
      dl_win_version: 'v2.8.9 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.8.9 \u00b7 Portable (.exe)',
    ...
    fr: {
      ...
      download_desc:
        'v2.8.9 — Les builds macOS sont désormais signés avec un certificat Developer ID et notarisés par Apple. Plus d\'avertissement Gatekeeper au premier lancement.',
      dl_win: 'Windows',
      dl_win_version: 'v2.8.9 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.8.9 \u00b7 Portable (.exe)',
    ...
    es: {
      ...
      download_desc:
        'v2.8.9 — Las versiones para macOS ahora están firmadas con un certificado Developer ID y notarizadas por Apple. Sin advertencia de Gatekeeper en el primer inicio.',
      dl_win: 'Windows',
      dl_win_version: 'v2.8.9 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.8.9 \u00b7 Portable (.exe)',
    ...
    it: {
      ...
      download_desc:
        'v2.8.9 — I build per macOS sono ora firmati con un certificato Developer ID e notarizzati da Apple. Nessun avviso di Gatekeeper al primo avvio.',
      dl_win: 'Windows',
      dl_win_version: 'v2.8.9 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.8.9 \u00b7 Portable (.exe)',
    ...
    nl: {
      ...
      download_desc:
        'v2.8.9 — macOS-builds zijn nu ondertekend met een Developer ID-certificaat en notarized door Apple. Geen Gatekeeper-waarschuwing meer bij eerste start.',
      dl_win: 'Windows',
      dl_win_version: 'v2.8.9 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.8.9 \u00b7 Portable (.exe)',
    ...
    pt: {
      ...
      download_title: 'Download',
      download_desc:
        'v2.8.9 — As versões para macOS agora são assinadas com um certificado Developer ID e autenticadas pela Apple. Sem aviso do Gatekeeper na primeira execução.',
      dl_win: 'Windows',
      dl_win_version: 'v2.8.9 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.8.9 \u00b7 Portable (.exe)',
    ...
    ko: {
      ...
      download_title: '\ub2e4\uc6b4\ub85c\ub4dc',
      download_desc:
        'v2.8.9 — macOS 빌드가 Developer ID 인증서로 서명되고 Apple에 의해 공증되었습니다. 첫 실행 시 Gatekeeper 경고가 표시되지 않습니다.',
      dl_win: 'Windows',
      dl_win_version: 'v2.8.9 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.8.9 \u00b7 Portable (.exe)',
    ...
    zh: {
      ...
      download_title: '\u4e0b\u8f7d',
      download_desc:
        'v2.8.9 — macOS 版本现已使用 Developer ID 证书签名并由 Apple 公证。首次启动不再显示 Gatekeeper 警告。',
      dl_win: 'Windows',
      dl_win_version: 'v2.8.9 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.8.9 \u00b7 Portable (.exe)',

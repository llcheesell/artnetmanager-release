(function () {
  const translations = {
    ja: {
      ...
      feat_cluster_desc: '複数インスタンスで冗長構成。自動リーダー選出とヘルスモニタリングで、ダウンタイムゼロのフェイルオーバーを実現。手動 Promote にも対応。',
    ...
    en: {
      ...
      feat_cluster_desc: 'Redundant multi-instance setup. Automatic leader election and health monitoring for zero-downtime failover. Manual Promote supported.',
    ...
    de: {
      ...
      download_title: 'Download',
      download_desc:
        'v2.7.12 \u2014 Merge-Engine, Multi-NIC und Guardian enthalten. 25 Zuverl\u00e4ssigkeitskorrekturen.',
      dl_win: 'Windows',
      dl_win_version: 'v2.7.12 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.7.12 \u00b7 Portable (.exe)',
    ...
    fr: {
      ...
      download_desc:
        'v2.7.12 \u2014 Moteur de fusion, multi-NIC et Guardian inclus. 25 corrections de fiabilit\u00e9.',
      dl_win: 'Windows',
      dl_win_version: 'v2.7.12 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.7.12 \u00b7 Portable (.exe)',
    ...
    es: {
      ...
      download_desc:
        'v2.7.12 \u2014 Motor de mezcla, multi-NIC y Guardian incluidos. 25 correcciones de fiabilidad.',
      dl_win: 'Windows',
      dl_win_version: 'v2.7.12 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.7.12 \u00b7 Portable (.exe)',
    ...
    it: {
      ...
      download_desc:
        'v2.7.12 \u2014 Motore di merge, multi-NIC e Guardian inclusi. 25 correzioni di affidabilit\u00e0.',
      dl_win: 'Windows',
      dl_win_version: 'v2.7.12 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.7.12 \u00b7 Portable (.exe)',
    ...
    nl: {
      ...
      download_desc:
        'v2.7.12 \u2014 Merge-engine, multi-NIC en Guardian inbegrepen. 25 betrouwbaarheidsverbeteringen.',
      dl_win: 'Windows',
      dl_win_version: 'v2.7.12 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.7.12 \u00b7 Portable (.exe)',
    ...
    pt: {
      ...
      download_title: 'Download',
      download_desc:
        'v2.7.12 \u2014 Motor de fus\u00e3o, multi-NIC e Guardian inclu\u00eddos. 25 corre\u00e7\u00f5es de fiabilidade.',
      dl_win: 'Windows',
      dl_win_version: 'v2.7.12 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.7.12 \u00b7 Portable (.exe)',
    ...
    ko: {
      ...
      download_title: '\ub2e4\uc6b4\ub85c\ub4dc',
      download_desc:
        'v2.7.12 \u2014 \uba38\uc9c0 \uc5d4\uc9c4, \uba40\ud2f0 NIC, \uac00\ub514\uc5b8 \ud0d1\uc7ac. 25\uac74\uc758 \uc548\uc815\uc131 \uc218\uc815.',
      dl_win: 'Windows',
      dl_win_version: 'v2.7.12 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.7.12 \u00b7 Portable (.exe)',
    ...
    zh: {
      ...
      download_title: '\u4e0b\u8f7d',
      download_desc:
        'v2.7.12 \u2014 \u5305\u542b\u5408\u5e76\u5f15\u64ce\u3001\u591a NIC\u3001Guardian\u300225 \u9879\u53ef\u9760\u6027\u4fee\u590d\u3002',
      dl_win: 'Windows',
      dl_win_version: 'v2.7.12 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.7.12 \u00b7 Portable (.exe)',

(function () {
  const translations = {
    ja: {
      ...
      hero_download_btn: 'Download v2.8.8',
      ...
      download_desc:
        'v2.8.8 — 通知システム追加・クラスターUX改善・バグ修正。',
      dl_win: 'Windows',
      dl_win_version: 'v2.8.8 · Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.8.8 · Portable (.exe)',
      dl_mac: 'macOS (Apple Silicon)',
      dl_mac_version: 'v2.8.8 · DMG (.dmg)',
    ...
    en: {
      ...
      download_desc:
        'v2.8.8 \u2014 Notification system, cluster UX improvements, and bug fixes.',
      dl_win: 'Windows',
      dl_win_version: 'v2.8.8 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.8.8 \u00b7 Portable (.exe)',
    ...
    de: {
      ...
      download_title: 'Download',
      download_desc:
        'v2.8.8 \u2014 Benachrichtigungssystem, Cluster-UX-Verbesserungen und Fehlerbehebungen.',
      dl_win: 'Windows',
      dl_win_version: 'v2.8.8 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.8.8 \u00b7 Portable (.exe)',
    ...
    fr: {
      ...
      download_desc:
        'v2.8.8 \u2014 Syst\u00e8me de notifications, am\u00e9liorations UX cluster et corrections de bugs.',
      dl_win: 'Windows',
      dl_win_version: 'v2.8.8 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.8.8 \u00b7 Portable (.exe)',
    ...
    es: {
      ...
      download_desc:
        'v2.8.8 \u2014 Sistema de notificaciones, mejoras de UX en cl\u00faster y correcciones de errores.',
      dl_win: 'Windows',
      dl_win_version: 'v2.8.8 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.8.8 \u00b7 Portable (.exe)',
    ...
    it: {
      ...
      download_desc:
        'v2.8.8 \u2014 Sistema di notifiche, miglioramenti UX cluster e correzioni di bug.',
      dl_win: 'Windows',
      dl_win_version: 'v2.8.8 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.8.8 \u00b7 Portable (.exe)',
    ...
    nl: {
      ...
      download_desc:
        'v2.8.8 \u2014 Notificatiesysteem, cluster UX-verbeteringen en bugfixes.',
      dl_win: 'Windows',
      dl_win_version: 'v2.8.8 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.8.8 \u00b7 Portable (.exe)',
    ...
    pt: {
      ...
      download_title: 'Download',
      download_desc:
        'v2.8.8 \u2014 Sistema de notifica\u00e7\u00f5es, melhorias de UX do cluster e corre\u00e7\u00f5es de bugs.',
      dl_win: 'Windows',
      dl_win_version: 'v2.8.8 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.8.8 \u00b7 Portable (.exe)',
    ...
    ko: {
      ...
      download_title: '\ub2e4\uc6b4\ub85c\ub4dc',
      download_desc:
        'v2.8.8 \u2014 \uc54c\ub9bc \uc2dc\uc2a4\ud15c, \ud074\ub7ec\uc2a4\ud130 UX \uac1c\uc120 \ubc0f \ubc84\uadf8 \uc218\uc815.',
      dl_win: 'Windows',
      dl_win_version: 'v2.8.8 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.8.8 \u00b7 Portable (.exe)',

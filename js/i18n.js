(function () {
  const translations = {
    ja: {
      ...
      hero_download_btn: 'Download v2.11.1',
      pillar1_label: 'Signal Management',
      pillar1_title: '信号の統合と伝送',
      pillar1_desc: 'Art-Net / sACN 信号を受信し、HTP・LTP・Priority でマージ。宛先ごとに送出するユニバースを選び、オフセットや遅延（0\u301C10秒）を個別に設定して同時転送。マルチ NIC 対応で、異なるサブネットの信号も一元管理。',
      ...
      download_desc:
        'v2.11.1: クラスタ(PRIMARY/STANDBY)冗長化を全面改善 — フェイルオーバーの安全化、二重PRIMARYの自動解消と警告通知、昇格時の出力継続性 — v2.10.7: LTC入力チャンネル選択 / Cluster STANDBYのForwarding設定保護 — v2.10.5: Art-Net + LTC両方のTimecode受信・転送、LTC Manager出力ツール — v2.8.9: macOS版を Apple Developer ID で署名・公証',
      dl_win: 'Windows',
      dl_win_version: 'v2.11.1 · Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.11.1 · Portable (.exe)',
      dl_mac: 'macOS (Universal)',
      dl_mac_version: 'v2.11.1 · DMG (.dmg)',
      dl_btn: 'Download',
      disclaimer_p1:
      ...
      past_versions: '過去のバージョンはこちら',
      companion_label: 'Companion App',
      companion_title: 'Timecode Tool（iPhone / iPad / Mac）',
      companion_desc: 'ライブのタイムコード用 iOS コンパニオンアプリ。LTC音声とArt-Netタイムコードを生成・監視・相互変換。ネットワーク上で ArtNet Manager と好相性。',
      companion_btn: 'Timecode Tool を見る',
    ...
    en: {
      ...
      pillar1_desc: 'Receive Art-Net / sACN signals and merge with HTP, LTP, or Priority. Choose which universes to send per destination, set individual offsets and delays (0\u201310 sec), and forward to multiple targets at once. Multi-NIC support for unified management across subnets.',
      pillar2_label: 'Record & Playback',
      ...
      download_desc:
        'v2.11.1: Cluster (PRIMARY/STANDBY) redundancy overhaul — safe failover, automatic dual-PRIMARY resolution with an operator alarm, output continuity on promotion — v2.10.7: LTC input channel selection / read-only Forwarding on cluster STANDBY — v2.10.5: Timecode reception + forwarding for Art-Net and LTC, LTC Manager output tool — v2.8.9: macOS builds signed and notarized with Apple Developer ID',
      dl_win: 'Windows',
      dl_win_version: 'v2.11.1 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.11.1 \u00b7 Portable (.exe)',
      ...
      past_versions: 'Previous versions',
      companion_label: 'Companion App',
      companion_title: 'Timecode Tool for iPhone / iPad / Mac',
      companion_desc: 'A companion iOS app for live timecode — generate, monitor, and convert between LTC audio and Art-Net Timecode. Pairs perfectly with ArtNet Manager on the network.',
      companion_btn: 'View Timecode Tool',
      teaser_label: 'Coming Soon',
      teaser_title: 'Next Update',
    ...
    de: {
      ...
      pillar1_desc: 'Art-Net / sACN Signale empfangen und mit HTP, LTP oder Priority zusammenführen. Pro Ziel wählbar, welche Universen gesendet werden, mit individuellen Offsets und Verzögerungen (0–10 Sek.). Multi-NIC für einheitliche Verwaltung über Subnetze hinweg.',
      pillar2_label: 'Record & Playback',
      ...
      past_versions: 'Frühere Versionen',
      companion_label: 'Companion App',
      companion_title: 'Timecode Tool für iPhone / iPad / Mac',
      companion_desc: 'Eine iOS-Begleit-App für Live-Timecode — LTC-Audio und Art-Net-Timecode erzeugen, überwachen und umwandeln. Ideal zusammen mit ArtNet Manager im Netzwerk.',
      companion_btn: 'Timecode Tool ansehen',
      teaser_label: 'Coming Soon',
      teaser_title: 'Next Update',
    ...
    fr: {
      ...
      pillar1_desc: 'Recevoir les signaux Art-Net / sACN et fusionner en HTP, LTP ou Priority. Choisir les univers \u00e0 envoyer par destination, avec offsets et d\u00e9lais individuels (0\u201310 sec.). Multi-NIC pour une gestion unifi\u00e9e entre sous-r\u00e9seaux.',
      pillar2_label: 'Record & Playback',
      ...
      past_versions: 'Versions précédentes',
      companion_label: 'Companion App',
      companion_title: 'Timecode Tool pour iPhone / iPad / Mac',
      companion_desc: 'Une application iOS compagnon pour le timecode en live — générez, surveillez et convertissez entre audio LTC et Art-Net Timecode. Parfaitement complémentaire d\'ArtNet Manager sur le réseau.',
      companion_btn: 'Voir Timecode Tool',
      teaser_label: 'Coming Soon',
      teaser_title: 'Next Update',
    ...
    es: {
      ...
      pillar1_desc: 'Recibir señales Art-Net / sACN y fusionar con HTP, LTP o Priority. Elegir qué universos enviar por destino, con offsets y retardos individuales (0–10 seg.). Multi-NIC para gestión unificada entre subredes.',
      pillar2_label: 'Record & Playback',
      ...
      companion_label: 'Companion App',
      companion_title: 'Timecode Tool para iPhone / iPad / Mac',
      companion_desc: 'Una app de iOS complementaria para timecode en directo: genera, monitoriza y convierte entre audio LTC y Art-Net Timecode. Combina perfectamente con ArtNet Manager en la red.',
      companion_btn: 'Ver Timecode Tool',
      teaser_label: 'Coming Soon',
      teaser_title: 'Next Update',
    ...
    it: {
      ...
      pillar1_desc: 'Ricevi segnali Art-Net / sACN e unisci con HTP, LTP o Priority. Scegli quali universi inviare per destinazione, con offset e ritardi individuali (0–10 sec.). Multi-NIC per gestione unificata tra sottoreti.',
      pillar2_label: 'Record & Playback',
      ...
      past_versions: 'Versioni precedenti',
      companion_label: 'Companion App',
      companion_title: 'Timecode Tool per iPhone / iPad / Mac',
      companion_desc: 'Un\'app iOS complementare per il timecode dal vivo: genera, monitora e converte tra audio LTC e Art-Net Timecode. Perfetta insieme ad ArtNet Manager in rete.',
      companion_btn: 'Apri Timecode Tool',
      teaser_label: 'Coming Soon',
      teaser_title: 'Next Update',
    ...
    nl: {
      ...
      pillar1_desc: 'Ontvang Art-Net / sACN signalen en voeg samen met HTP, LTP of Priority. Kies per bestemming welke universen worden gestuurd, met individuele offsets en vertraging (0–10 sec.). Multi-NIC voor uniform beheer over subnetten.',
      pillar2_label: 'Record & Playback',
      ...
      past_versions: 'Eerdere versies',
      companion_label: 'Companion App',
      companion_title: 'Timecode Tool voor iPhone / iPad / Mac',
      companion_desc: 'Een iOS-begeleidende app voor live timecode — genereer, monitor en converteer tussen LTC-audio en Art-Net Timecode. Perfect samen met ArtNet Manager op het netwerk.',
      companion_btn: 'Bekijk Timecode Tool',
      teaser_label: 'Coming Soon',
      teaser_title: 'Next Update',
    ...
    pt: {
      ...
      pillar1_desc: 'Receba sinais Art-Net / sACN e combine com HTP, LTP ou Priority. Escolha quais universos enviar por destino, com offsets e atrasos individuais (0–10 seg.). Multi-NIC para gestão unificada entre sub-redes.',
      pillar2_label: 'Record & Playback',
      ...
      past_versions: 'Versões anteriores',
      companion_label: 'Companion App',
      companion_title: 'Timecode Tool para iPhone / iPad / Mac',
      companion_desc: 'Um app iOS complementar para timecode ao vivo — gere, monitore e converta entre áudio LTC e Art-Net Timecode. Combina perfeitamente com o ArtNet Manager na rede.',
      companion_btn: 'Ver Timecode Tool',
      teaser_label: 'Coming Soon',
      teaser_title: 'Next Update',
    ...
    ko: {
      ...
      pillar1_desc: 'Art-Net / sACN \uc2e0\ud638\ub97c \uc218\uc2e0\ud558\uace0 HTP, LTP \ub610\ub294 Priority\ub85c \ubcd1\ud569. \ub300\uc0c1\ubcc4\ub85c \uc804\uc1a1\ud560 \uc720\ub2c8\ubc84\uc2a4\ub97c \uc120\ud0dd\ud558\uace0, \uac1c\ubcc4 \uc624\ud504\uc14b\uacfc \uc9c0\uc5f0(0\u201310\ucd08)\uc744 \uc124\uc815\ud558\uc5ec \ub3d9\uc2dc \uc804\ub2ec. \ub2e4\uc911 NIC\ub85c \uc11c\ube0c\ub137 \uac04 \ud1b5\ud569 \uad00\ub9ac.',
      pillar2_label: 'Record & Playback',
      ...
      past_versions: '이전 버전 보기',
      companion_label: 'Companion App',
      companion_title: 'Timecode Tool (iPhone / iPad / Mac)',
      companion_desc: '라이브 타임코드용 iOS 컴패니언 앱 — LTC 오디오와 Art-Net 타임코드를 생성·모니터링·상호 변환. 네트워크에서 ArtNet Manager와 완벽하게 어울립니다.',
      companion_btn: 'Timecode Tool 보기',
      teaser_label: 'Coming Soon',
      teaser_title: 'Next Update',
    ...
    zh: {
      ...
      pillar1_desc: '\u63a5\u6536 Art-Net / sACN \u4fe1\u53f7\u5e76\u4ee5 HTP\u3001LTP \u6216 Priority \u5408\u5e76\u3002\u6309\u76ee\u6807\u9009\u62e9\u53d1\u9001\u54ea\u4e9b Universe\uff0c\u5355\u72ec\u8bbe\u7f6e\u504f\u79fb\u548c\u5ef6\u8fdf\uff080\u201310 \u79d2\uff09\uff0c\u540c\u65f6\u8f6c\u53d1\u3002\u591a NIC \u652f\u6301\u8de8\u5b50\u7f51\u7edf\u4e00\u7ba1\u7406\u3002',
      pillar2_label: 'Record & Playback',
      ...
      companion_label: 'Companion App',
      companion_title: 'Timecode Tool（iPhone / iPad / Mac）',
      companion_desc: '用于现场时间码的 iOS 配套应用 — 在 LTC 音频与 Art-Net 时间码之间生成、监看和互转，与网络中的 ArtNet Manager 完美搭配。',
      companion_btn: '查看 Timecode Tool',
      teaser_label: 'Coming Soon',
      teaser_title: 'Next Update',

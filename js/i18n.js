(function () {
  const translations = {
    ja: {
      ...
      hero_download_btn: 'Download v2.10.5',
      ...
      download_desc:
        'v2.10.5 — タイムコード受信・転送、LTC Manager（新ウィンドウ）に対応。安定性も向上しました。',
      dl_win: 'Windows',
      dl_win_version: 'v2.10.5 · Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.10.5 · Portable (.exe)',
      dl_mac: 'macOS (Universal)',
      dl_mac_version: 'v2.10.5 · DMG (.dmg)',
      dl_btn: 'Download',
      disclaimer_p1:
    ...
    en: {
      ...
      download_desc:
        'v2.10.5 — Timecode reception & forwarding, plus the new LTC Manager window. Stability improvements throughout.',
      dl_win: 'Windows',
      dl_win_version: 'v2.10.5 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.10.5 \u00b7 Portable (.exe)',
    ...
    de: {
      ...
      download_title: 'Download',
      download_desc:
        'v2.10.5 — Timecode-Empfang und -Weiterleitung sowie das neue LTC-Manager-Fenster. Mit allgemeinen Stabilitätsverbesserungen.',
      dl_win: 'Windows',
      dl_win_version: 'v2.10.5 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.10.5 \u00b7 Portable (.exe)',
    ...
    fr: {
      ...
      download_desc:
        'v2.10.5 — Réception et transfert de timecode, et nouvelle fenêtre LTC Manager. Améliorations de stabilité incluses.',
      dl_win: 'Windows',
      dl_win_version: 'v2.10.5 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.10.5 \u00b7 Portable (.exe)',
    ...
    es: {
      ...
      download_desc:
        'v2.10.5 — Recepción y reenvío de timecode, y la nueva ventana LTC Manager. Con mejoras de estabilidad.',
      dl_win: 'Windows',
      dl_win_version: 'v2.10.5 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.10.5 \u00b7 Portable (.exe)',
    ...
    it: {
      ...
      download_desc:
        'v2.10.5 — Ricezione e inoltro del timecode, e la nuova finestra LTC Manager. Con miglioramenti di stabilità.',
      dl_win: 'Windows',
      dl_win_version: 'v2.10.5 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.10.5 \u00b7 Portable (.exe)',
    ...
    nl: {
      ...
      download_desc:
        'v2.10.5 — Timecode-ontvangst en doorsturen, en het nieuwe LTC Manager-venster. Inclusief stabiliteitsverbeteringen.',
      dl_win: 'Windows',
      dl_win_version: 'v2.10.5 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.10.5 \u00b7 Portable (.exe)',
    ...
    pt: {
      ...
      download_title: 'Download',
      download_desc:
        'v2.10.5 — Recepção e encaminhamento de timecode, e a nova janela LTC Manager. Com melhorias de estabilidade.',
      dl_win: 'Windows',
      dl_win_version: 'v2.10.5 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.10.5 \u00b7 Portable (.exe)',
    ...
    ko: {
      ...
      download_title: '\ub2e4\uc6b4\ub85c\ub4dc',
      download_desc:
        'v2.10.5 — 타임코드 수신·전송 및 새로운 LTC Manager 창을 추가했습니다. 안정성도 개선되었습니다.',
      dl_win: 'Windows',
      dl_win_version: 'v2.10.5 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.10.5 \u00b7 Portable (.exe)',
    ...
    zh: {
      ...
      download_title: '\u4e0b\u8f7d',
      download_desc:
        'v2.10.5 — 新增时间码接收与转发，以及全新的 LTC Manager 窗口。同时提升整体稳定性。',
      dl_win: 'Windows',
      dl_win_version: 'v2.10.5 \u00b7 Installer (.exe)',
      dl_win_portable: 'Windows Portable',
      dl_win_portable_version: 'v2.10.5 \u00b7 Portable (.exe)',
